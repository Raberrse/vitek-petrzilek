...
export default function AboutMe() {
  return (
    <div className='w-full pt-[170px] pb-[110px] flex items-center justify-center px-[150px] max-xl:px-[90px] max-lg:px-[60px] max-sm:px-[30px]'>
        <div className='flex max-lg:flex-col gap-14 justify-center w-full max-w-[1200px] '>
            ...
            <div className='relative w-full flex items-center justify-center max-md:px-6'>
