      ...
      <div className="relative z-0">
        ...
        {Array(numRows)
          ...
          .map((_, rowIndex) => {
            ...
            const hasTwoItems = rowProjects.length === 2;

            return (
              <div
                key={rowIndex}
                className={`grid ${
                  isLastRow && hasTwoItems
                    ? "grid-cols-2 max-lg:grid-cols-1" // Special case for last row with two projects
                ...
                {rowProjects.map((project: any, projectIndex) => (
                  <div
                    ...
                    className={`relative flex-1 ${isLoaded && 'group/container'} ${
                      isLastRow && hasTwoItems
                        ? "" // No odd/even classes for the last row
                        : rowIndex % 2 === 0
