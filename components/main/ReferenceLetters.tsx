...
export default function ReferenceLetters() {
  return (
    <div id={'reference'} className='flex flex-col gap-y-[65px] items-center justify-center pt-[140px] pb-[70px] px-[90px] max-lg:px-[60px] max-sm:px-[30px]'>
      
      <h2 className='text-[38px] font-bold'>Reference</h2>
